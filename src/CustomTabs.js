...
export default function SimpleTabs() {
  ...
  return (
    ...
    -  */}
          ...
          <p>  There are ways to make the experience even more realistic in VR by tying a resistance band to the ceiling attached to your hand/controllers which could actually give resistance while pulling yourself up</p>
