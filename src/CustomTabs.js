  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={1}>
        ...
        <section >
          <h1 style={{ textAlign: "center" }}>Project 2: (Don't Fear) The Reaper</h1>
          <br />
          <br />
          <h2 style={{ textAlign: "center", color: "blue" }}>Introduction</h2>
          <br />
          <p> The user spawns on the side of the road and first has to make their way if the user is unable to handle the phobia simulation they could come back and tap the red button which would end the simulation.
          </p>
          <br />
          <p>
            <b>Objectives :</b>  The user's goal is to carry out a basic task while being chased by a monster and defeat the monsters and overcome your fears. The User cannot directly fight the monsters, they can only run away. they would have to stay calm and try to find other ways    The red button acts as a safety switch and will remain in the scene after the simulation starts.
          </p>
          <br />
          <p>
            <b>Chernobyl:</b>  My original plan was to project a model of the abandoned Ferris wheel from Pripyat amusement park but not many people were aware of its existence and could not relate, so I went on and added a representation of the burning nuclear plant from "that incident".
